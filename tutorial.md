```python
  ...
  #The data file path is the raw data url on github. Happily python can read directly from a web pageself.
  #I picked a file on my own computer

  data_file_path = "/Users/Emily/Desktop/4530/Temp_Trees.tsv"
  ...
  plt.savefig('/Users/Emily/Desktop/4530')
  plt.show()


```

$$y =  -1.4263047124758768*x + 84.2296061966423$$
