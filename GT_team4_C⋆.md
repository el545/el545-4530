...
# Plot the raw data
plotnum = [2,6,10,15,22] #for representative data columns
plt.figure(1)
plt.xlabel(r'$time (s)$')
...
plt.legend(['flow rate=125muM/s', 'flow rate=250muM/s', 'flow rate=475muM/s', 'flow rate=650muM/s', 'flow rate=850muM/s'])

plt.savefig("/Users/Emily Liu/Desktop/CEE 4530/lab5q2")
...
plt.xlabel(r'$time (s)$')
plt.ylabel(r'Oxygen concentration $\left ( \frac{mg}{L} \right )$')
plt.legend(['DO vs time','actual DO vs time'])
